...
public class Mat3x3 {
    ...
    // Static functions...
    public static Mat3x3 add(Mat3x3 m1, Mat3x3 m2) {
        Mat3x3 ret = Mat3x3.copy(m1);
        return ret.add(m2);
    }
    public static Mat3x3 subtract(Mat3x3 m1, Mat3x3 m2) {
        Mat3x3 ret = Mat3x3.copy(m1);
        return ret.subtract(m2);
    }
    public static Mat3x3 multiply(Mat3x3 m1, Mat3x3 m2) {
        Mat3x3 ret = Mat3x3.copy(m1);
        return ret.multiply(m2);
    }
    public static Mat3x3 scale(Mat3x3 m1, double s) {
        Mat3x3 ret = Mat3x3.copy(m1);
        return ret.scale(s);
    }
    public static double det(Mat3x3 m) {
        return m.det();
    }
    
    public static Mat3x3 copy(Mat3x3 other) {
